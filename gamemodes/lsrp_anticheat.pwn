...
public OnIncomingRPC(playerid, rpcid, BitStream:bs)
{
	...
	switch(rpcid)
	{
		/*case 24: // SetVehicleParamsEx
		{
			new vehicleid, bool: enginestate, bool: lights, bool: alarm, bool: doors, bool: bonnet, bool: boot, bool: objective;
			BS_ReadValue(bs, PR_UINT32, vehicleid, PR_BOOL, enginestate, PR_BOOL, lights, PR_BOOL, alarm, PR_BOOL, doors, PR_BOOL, bonnet, PR_BOOL, boot, PR_BOOL, objective);

			if(CarEngine[vehicleid] != enginestate)
			{
				enginestate = false;
				BS_Reset(bs);
		...
		case 115: // GiveTakeDamage 
		{
			...
			if(dWeaponID != 46 && dWeaponID != 40 && dWeaponID > 0 && dWeaponID != PlayerData[playerid][pWeapons][slot])
			{
				PlayerData[playerid][pWeapons][slot] = PlayerData[playerid][pWeaponsAmmo][slot] = 0;
